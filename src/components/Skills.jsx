                ...
                <>
                    <div className='grid grid-cols-4'>
                        {SKILLS.map((skill, idx) => {
                            if (idx % 9 == 0) return <div className='m-2  font-bold text-center bg-[#086788] inline-block p-4 border col-span-2 rounded-xl'>
                                {skill}
                            </div>
                            return <div className='m-2 bg-[#086788] text-center  font-bold inline-block p-4 border rounded-xl'>
                                {skill}
                            </div>
                        })}
                    </div>
